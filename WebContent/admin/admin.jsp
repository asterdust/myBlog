...
<head>
	...
	<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/static/css/admin.css" />

	<script src="${pageContext.request.contextPath}/static/js/admin.js" type="javascript"></script>
...
<div class="container" id="main">
	...
	<div id="header">
		<div>
			<h2><a href="${pageContext.request.contextPath}/login.html">MyBlog</a><span style="font-size: small;">  管理</span></h2>
		</div>
	</div>
