                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input id="id" type="text" class="form-control" name="id" value="${edit_article.id}" readonly="readonly">
                                    </div>
                                    <div class="form-group">
                                        <label for="title">标题</label>
                                        <input id="title" type="text" class="form-control" name="title" value="${edit_article.title}">
                                    </div>
                                    <div class="form-group">
                                        <label for="time">时间</label>
                                        <input id="time" type="text" class="form-control" name="time" value="${edit_article.time}">
                                    </div>
                                    <div class="form-group">
                                        <label for="author">作者</label>
                                        <input id="author" type="text" class="form-control" name="author" value="${edit_article.author}">
                                    </div>
                                    <div class="form-group">
                                        <label>分类</label>
                                        ...
                                        <input id="sort" type="text" class="form-control" name="sort" value="${edit_article.sort}">
                                    </div>
                                    <div class="form-group">
                                        <label>标签</label>
